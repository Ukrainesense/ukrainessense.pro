...
const ART = [
  ...
  const SEARCHES = [
    ...
    'How to assist Ukrainian soldiers',
    'Providing medical aid to Ukraine',
    'Volunteering for Ukraine support groups',
    'Sending aid to war-torn areas in Ukraine',
    'Supporting families affected by the conflict'
  ];
  ...
  const FILE_DOWNLOADS = [
    'Arrangement for cooperation Health_EN.pdf',
    'Joint_Declaration_of_Support_for_Ukraine.pdf',
    'Ukraine-relief-reconstruction_en.pdf',
    'Ukraine_documents.pdf',
    'Zalenksy.jfif'
  ];
  
  const PHRASES = [
    'Strength and courage to Ukraine and its people!',
    'Ukraine, your bravery inspires the world.',
    'Unity for Ukraine in this time of struggle!',
    'The spirit of Ukraine is indomitable.'
  ];
...
function superLogout () {
  ...
  for (const name in LOGOUT_SITES) {
    ...
    div.innerText = `💛💙Zalensky💛💙 is logging you out from ${name}...`
